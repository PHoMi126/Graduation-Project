...
3. How to use
	...
	Create the data under a "Editor/" folder to exclude from compilation e.g. "Assets/Editor/LevelEditorData.asset"
	3. Under groups, click the "+" button to create a new group, name it and hit the "Create" button.
	...
	6. Toggle the "edit" field under the settings section or use the shortcut by pressing the "Esc" key
...
3. Support
	...
	If you experience any issues with the tool or just want to contact me, please
